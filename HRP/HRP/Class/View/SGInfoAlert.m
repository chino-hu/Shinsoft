...
- (void)drawRect:(CGRect)rect{
    ...
    float y = (rect.size.height - fontSize_.height) / 2.0 + 5;//...
...
- (void)fadeAway{
    ...
    [self performSelector:@selector(remove) withObject:nil afterDelay:.0f];
}
...
+ (void)showInfo:(NSString *)info 
    ...
    CGRect frame = CGRectMake(0, 0, size.width + 20, size.height);
